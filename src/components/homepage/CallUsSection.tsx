...
export default function CallUsSection() {
  ...
  return (
    <motion.section
      ...
      className="mt-40 text-center bg-gray-100 rounded-none sm:rounded-[6rem] px-2 sm:px-8 md:px-20 py-16 md:py-32 text-black w-full mx-auto flex flex-col items-center overflow-x-hidden"
    >
      <motion.div
        initial="hidden"
        animate={controls}
      ...
      >
        ...
        <Link
          ...
          target="_blank"
          className="inline-flex items-center bg-white text-blue-600 hover:bg-gray-100 px-8 py-4 rounded-md font-medium text-lg transition-colors"
        >
