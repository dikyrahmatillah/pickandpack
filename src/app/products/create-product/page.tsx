...
export default function CreateProductPage() {
  ...
  const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setImageFiles(files);
    // Convert files to data URLs for preview and submission
    Promise.all(
      files.map(
        (file) =>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              <label htmlFor="images" className="block text-sm font-medium text-gray-700 mb-1">
                Images (comma separated URLs or upload below)
              </label>
              <input
                type="text"
                id="images"
                ...
                className="w-full p-2 border border-gray-300 rounded-none focus:outline-none focus:ring-2 focus:ring-blue-500 mb-2"
